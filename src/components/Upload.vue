<template>
    <div class="col-span-1">
        <div class="bg-white shadow-lg rounded border border-gray-200 relative flex flex-col">
            ...
            <div class="p-6">
                ...
                hover:bg-green-400 hover:border-green-400 hover:border-solid"
                    :class="{ 'bg-gree-400 border-green-400 border-solid': is_dragover }" @drag.prevent.stop=""
    ...
    methods: {
        upload($event) {
            ...
            files.forEach((file) => {
                ...
                const storageRef = storage.ref() //music-a5f43.appspot.com
                const songsRef = storageRef.child(`songs/${file.name}`) // music-a5f43.appspot.com/songs/example.mp3
