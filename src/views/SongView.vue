    ...
    <main>
        ...
        <section class="w-full mb-8 py-14 text-center text-white relative">
            <div class="absolute inset-0 w-full h-full box-border bg-contain music-bg"
                style="background-image: url(/images/song-header.png)">
            </div>
            <div class="container mx-auto flex items-center">
                <!-- Play/Pause Button -->
                <button @click.prevent="newSong(song)" type="button" class="z-50 h-24 w-24 text-3xl bg-white text-black rounded-full
        focus:outline-none">
        ...
        <section id="comments" class="container mx-auto mt-6">
            <div class="bg-white rounded border border-gray-200 relative flex flex-col">
              ...
              duration-500 focus:outline-none focus:border-black rounded mb-4"
                        ...
                        <ErrorMessage class="text-rred-600" name="comment" />
...
export default {
    ...
    methods: {
        ...
        async addComment(values, { resetForm }) {
            this.comment_alert_message = true;
    ...
    watch: {
        sort(newVal) {
            ...
            // Push accept change we'd like to make on the next route
            this.$router.push({
                query: {
                    sort: newVal,
                }
